  ...
  return (
    <section id="ai-delivery" className="ai-delivery" style={vars} aria-labelledby="ai-delivery-title">
      <style>{`
        ...
        .ai-modal-layer{position:fixed;inset:0;z-index:1250;display:grid;place-items:center;padding:20px;background:rgba(4,7,17,.74);backdrop-filter:blur(8px);-webkit-backdrop-filter:blur(8px)}.ai-modal{width:min(720px,100%);max-height:min(84vh,760px);overflow:auto;border:1px solid var(--ai-border);border-radius:22px;background:var(--ai-bg2);color:var(--ai-text);box-shadow:0 36px 110px -38px rgba(0,0,0,.88)}.ai-modal-head{position:sticky;top:0;z-index:2;display:flex;justify-content:space-between;gap:18px;padding:22px 24px 18px;border-bottom:1px solid var(--ai-border);background:var(--ai-bg2)}.ai-modal-kicker{font-size:9.5px;font-weight:850;text-transform:uppercase;letter-spacing:.12em;color:#22d3ee}.ai-modal h2{margin:7px 0 0;font-size:27px;line-height:1.1;letter-spacing:-.035em}.ai-close{flex:0 0 auto;width:38px;height:38px;border:1px solid var(--ai-border);border-radius:50%;background:var(--ai-card);color:var(--ai-text);font-size:20px;cursor:pointer}.ai-modal-body{padding:22px 24px 26px;display:grid;gap:14px}.ai-block{padding:15px 16px;border:1px solid var(--ai-border);border-radius:14px;background:var(--ai-card)}.ai-block h3{margin:0 0 7px;font-size:10px;text-transform:uppercase;letter-spacing:.1em;color:var(--ai-muted)}.ai-block p{margin:0;font-size:13px;line-height:1.6}.ai-example{border-color:rgba(34,197,94,.25)}.ai-example h3{color:#22c55e}.ai-output-list{display:flex;gap:7px;flex-wrap:wrap}.ai-output{padding:6px 9px;border-radius:999px;background:rgba(34,211,238,.1);color:#22d3ee;font-size:11px;font-weight:750}
        @media(max-width:900px){.ai-grid{grid-template-columns:1fr 1fr}}
        @media(max-width:640px){.ai-delivery{padding:78px 20px}.ai-grid{grid-template-columns:1fr}.ai-principle{padding:15px}.ai-modal-head,.ai-modal-body{padding-left:18px;padding-right:18px}.ai-modal h2{font-size:24px}}
        @media(prefers-reduced-motion:reduce){.ai-delivery *{transition:none!important}}
      `}</style>
